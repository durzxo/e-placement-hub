    ...
    <Router>
      <Routes>
        ...
        <Route path="/dashboard" element={
          isAuthenticated ? ( <Layout onLogout={handleLogout} userRole={userRole}><DashboardPage /></Layout> ) : (<Navigate to="/login" />)
        }/>
        <Route path="/notices" element={
          isAuthenticated ? ( <Layout onLogout={handleLogout} userRole={userRole}><NoticesPage /></Layout> ) : (<Navigate to="/login" />)
        }/>
        <Route path="/students" element={
          isAuthenticated ? ( <Layout onLogout={handleLogout} userRole={userRole}><StudentsPage /></Layout> ) : (<Navigate to="/login" />)
        }/>
        <Route path="/drives" element={
          isAuthenticated ? ( <Layout onLogout={handleLogout} userRole={userRole}><DrivesListPage /></Layout> ) : (<Navigate to="/login" />)
        }/>
